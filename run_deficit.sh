...
python code/deficit_calcs/deficit_main.py data/timeseries/ca_sites/ca_sites.csv dir_deficit -new_directory True -show_modis True -interpolate True -xtra_imports False
