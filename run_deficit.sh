...
python3 code/deficit_calcs/deficit_main.py watershed_11475560/ee_extractions/exports/watershed_extractions_w_merge_on_date.csv watershed_11475560 -single_site True -new_directory False -show_modis True -interpolate True -xtra_imports False
